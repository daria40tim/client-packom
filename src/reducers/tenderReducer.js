...
export const selectTenderFilterDataReducer = (state = {data: {tz_ids: [], projs: []}}, action) => {
    switch (action.type) {
        case GET_TENDER_FILTER_DATA_REQUEST:
            return {loading: true, ...state}
        case GET_TENDER_FILTER_DATA_SUCCESS:
            return {loading: false, data: action.payload}
        case GET_TENDER_FILTER_DATA_FAIL:
            return {loading: false, error: action.payload}
        default: 
            return state
    }
